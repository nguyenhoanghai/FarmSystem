    ...
    public class SQLConnectController : Controller
    {
        ...
        public JsonResult SaveConfig(string ip, string uname, string pass, bool isAuthen, string dbname)
        {
            ...
            try
            {
                ...
                string directoryPath = Server.MapPath("~/Config_XML");
                ...
                xmlNode3.AppendChild(xmlDocument.CreateTextNode(Helper.EncryptionHelper.Instance.Encrypt(ip)));
                xmlNode2.AppendChild(xmlNode3);

                XmlNode xmlNode4 = xmlDocument.CreateElement("Database");
                xmlNode4.AppendChild(xmlDocument.CreateTextNode(Helper.EncryptionHelper.Instance.Encrypt(dbname)));
                xmlNode2.AppendChild(xmlNode4);

                XmlNode xmlNode5 = xmlDocument.CreateElement("User");
                xmlNode5.AppendChild(xmlDocument.CreateTextNode(Helper.EncryptionHelper.Instance.Encrypt(uname)));
                xmlNode2.AppendChild(xmlNode5);

                XmlNode xmlNode6 = xmlDocument.CreateElement("Password");
                xmlNode6.AppendChild(xmlDocument.CreateTextNode(Helper.EncryptionHelper.Instance.Encrypt(pass)));
